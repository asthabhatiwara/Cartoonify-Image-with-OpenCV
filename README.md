...
### Image Filtering
   Implemented bilateral filter for edge preserving and noise reduction-<br/>
      Similarly to the Gaussian, bilateral filter replaces each pixel value with a weighted average of nearby pixel values.<br/>
